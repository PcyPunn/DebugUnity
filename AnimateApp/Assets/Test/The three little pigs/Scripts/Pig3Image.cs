...
public class Pig3Image : MonoBehaviour
{
    public static Pig3Image Instance;
    ...
    void Start()
    {
        Debug.Log("Pig3 Image script started.");

        if (targetImage != null)
        {
            Debug.Log("Pig3 Image is assigned.");
        ...
        {
            Debug.LogError("Pig3 Image is not assigned.");
        }
    }
