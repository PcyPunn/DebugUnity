...
public class PigmomImage : MonoBehaviour
{
    public static PigmomImage Instance;
    ...
    void Start()
    {
        Debug.Log("PigMom Image script started.");

        if (targetImage != null)
        {
            Debug.Log("PigMom Image is assigned.");
        ...
        {
            Debug.LogError("PigMom Image is not assigned.");
        }
    }
