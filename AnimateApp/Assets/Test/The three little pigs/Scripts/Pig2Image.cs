...
public class Pig2Image : MonoBehaviour
{
    public static Pig2Image Instance;
    ...
    void Start()
    {
        Debug.Log("Pig2 Image script started.");

        if (targetImage != null)
        {
            Debug.Log("Pig2 Image is assigned.");
        ...
        {
            Debug.LogError("Pig2 Image is not assigned.");
        }
    }
