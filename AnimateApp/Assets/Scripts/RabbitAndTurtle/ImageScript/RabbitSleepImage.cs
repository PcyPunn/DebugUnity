...
public class RabbitSleepImage : MonoBehaviour
{
    public static RabbitSleepImage Instance;
    ...
    void Start()
    {
        ...
        {
            StartCoroutine(HandleTextureSetup(StaticClassForPassingData.RabbitSleepTexture));
        }
        else
        {
