...
public class RabbitWorryImage : MonoBehaviour
{
    public static RabbitWorryImage Instance;
    ...
    void Start()
    {
        ...
        {
            StartCoroutine(HandleTextureSetup(StaticClassForPassingData.RabbitWorryTexture));
        }
        else
        {
