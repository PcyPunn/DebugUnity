...
public class TurtleBodySprite : MonoBehaviour
{
    public static TurtleBodySprite Instance;
    ...
    void Start()
    {
        Debug.Log("TurtleBody script started.");

        if (targetSpriteRenderer != null)
        {
            Debug.Log("TurtleBody SpriteRenderer is assigned.");
        ...
        {
            Debug.LogError("TurtleBody SpriteRenderer is not assigned.");
        }
    }
