...
public class TurtleLegBackRSprite : MonoBehaviour
{
    public static TurtleLegBackRSprite Instance;
    ...
    void Start()
    {
        Debug.Log("TurtleLegBackR script started.");

        if (targetSpriteRenderer != null)
        {
            Debug.Log("TurtleLegBackR SpriteRenderer is assigned.");
        ...
        {
            Debug.LogError("TurtleLegBackR SpriteRenderer is not assigned.");
        }
    }
