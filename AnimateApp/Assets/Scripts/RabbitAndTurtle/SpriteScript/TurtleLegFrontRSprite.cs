...
public class TurtleLegFrontRSprite : MonoBehaviour
{
    public static TurtleLegFrontRSprite Instance;
    ...
    void Start()
    {
        Debug.Log("TurtleLegFrontR script started.");

        if (targetSpriteRenderer != null)
        {
            Debug.Log("TurtleLegFrontR SpriteRenderer is assigned.");
        ...
        {
            Debug.LogError("TurtleLegFrontR SpriteRenderer is not assigned.");
        }
    }
