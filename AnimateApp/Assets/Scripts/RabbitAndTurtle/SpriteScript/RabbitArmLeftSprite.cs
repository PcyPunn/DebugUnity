...
public class RabbitArmLeftSprite : MonoBehaviour
{
    public static RabbitArmLeftSprite Instance;
    ...
    void Start()
    {
        Debug.Log("RabbitArmLeft script started.");

        if (targetSpriteRenderer != null)
        {
            Debug.Log("RabbitArmLeft SpriteRenderer is assigned.");
        ...
        {
            Debug.LogError("RabbitArmLeft SpriteRenderer is not assigned.");
        }
    }
