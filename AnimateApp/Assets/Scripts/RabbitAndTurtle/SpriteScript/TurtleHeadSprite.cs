...
public class TurtleHeadSprite : MonoBehaviour
{
    public static TurtleHeadSprite Instance;
    ...
    void Start()
    {
        Debug.Log("TurtleHead script started.");

        if (targetSpriteRenderer != null)
        {
            Debug.Log("TurtleHead SpriteRenderer is assigned.");
        ...
        {
            Debug.LogError("TurtleHead SpriteRenderer is not assigned.");
        }
    }
