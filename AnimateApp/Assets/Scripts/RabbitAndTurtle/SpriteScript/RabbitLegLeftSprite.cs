...
public class RabbitLegLeftSprite : MonoBehaviour
{
    public static RabbitLegLeftSprite Instance;
    ...
    void Start()
    {
        Debug.Log("RabbitLegLeft script started.");

        if (targetSpriteRenderer != null)
        {
            Debug.Log("RabbitLegLeft SpriteRenderer is assigned.");
        ...
        {
            Debug.LogError("RabbitLegLeft SpriteRenderer is not assigned.");
        }
    }
