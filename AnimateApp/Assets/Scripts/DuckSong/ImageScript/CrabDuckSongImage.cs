...
public class CrabDuckSongImage : MonoBehaviour
{
    public static CrabDuckSongImage Instance;
    ...
    void Start()
    {
        Debug.Log("Crab Image script started.");

        if (targetImage != null)
        {
            Debug.Log("Crab Image is assigned.");
        ...
        {
            Debug.LogError("Crab Image is not assigned.");
        }
    }
