...
public class FishDuckSongImage : MonoBehaviour
{
    public static FishDuckSongImage Instance;
    ...
    void Start()
    {
        Debug.Log("Fish Image script started.");

        if (targetImage != null)
        {
            Debug.Log("Fish Image is assigned.");
        ...
        {
            Debug.LogError("Fish Image is not assigned.");
        }
    }
