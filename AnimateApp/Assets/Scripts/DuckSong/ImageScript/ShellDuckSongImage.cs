...
public class ShellDuckSongImage : MonoBehaviour
{
    public static ShellDuckSongImage Instance;
    ...
    void Start()
    {
        Debug.Log("Shell Image script started.");

        if (targetImage != null)
        {
            Debug.Log("Shell Image is assigned.");
        ...
        {
            Debug.LogError("Shell Image is not assigned.");
        }
    }
