...
public class Stone13CAJSprite : MonoBehaviour
{
    public static Stone13CAJSprite Instance;
    ...
    void Start()
    {
        Debug.Log("Stone13 script started.");

        if (targetSpriteRenderer != null)
        {
            Debug.Log("Stone13 SpriteRenderer is assigned.");
        ...
        {
            Debug.LogError("Stone13 SpriteRenderer is not assigned.");
        }
    }
    ...
    private void SaveTexture(Texture2D texture)
    {
        ...
        PlayerPrefs.SetString("SavedStone13CAJ", encodedTexture);
        PlayerPrefs.Save();
