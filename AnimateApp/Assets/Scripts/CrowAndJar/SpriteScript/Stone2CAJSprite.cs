...
public class Stone2CAJSprite : MonoBehaviour
{
    public static Stone2CAJSprite Instance;
    ...
    void Start()
    {
        Debug.Log("Stone2 script started.");

        if (targetSpriteRenderer != null)
        {
            Debug.Log("Stone2 SpriteRenderer is assigned.");
        ...
        {
            Debug.LogError("Stone2 SpriteRenderer is not assigned.");
        }
    }
    ...
    private void SaveTexture(Texture2D texture)
    {
        ...
        PlayerPrefs.SetString("SavedStone2CAJ", encodedTexture);
        PlayerPrefs.Save();
