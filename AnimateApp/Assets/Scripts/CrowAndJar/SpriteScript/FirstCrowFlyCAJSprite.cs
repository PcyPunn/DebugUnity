...
public class FirstCrowFlyCAJSprite : MonoBehaviour
{
    public static FirstCrowFlyCAJSprite Instance;
    ...
    void Start()
    {
        Debug.Log("1stCrowFly script started.");

        if (targetSpriteRenderer != null)
        {
            Debug.Log("1stCrowFly SpriteRenderer is assigned.");
        ...
        {
            Debug.LogError("1stCrowFly SpriteRenderer is not assigned.");
        }
    }
    ...
    private void SaveTexture(Texture2D texture)
    {
        ...
        PlayerPrefs.SetString("Saved1stCrowFlyCAJ", encodedTexture);
        PlayerPrefs.Save();
