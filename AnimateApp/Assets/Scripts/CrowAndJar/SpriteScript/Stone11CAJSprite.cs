...
public class Stone11CAJSprite : MonoBehaviour
{
    public static Stone11CAJSprite Instance;
    ...
    void Start()
    {
        Debug.Log("Stone11 script started.");

        if (targetSpriteRenderer != null)
        {
            Debug.Log("Stone11 SpriteRenderer is assigned.");
        ...
        {
            Debug.LogError("Stone11 SpriteRenderer is not assigned.");
        }
    }
    ...
    private void SaveTexture(Texture2D texture)
    {
        ...
        PlayerPrefs.SetString("SavedStone11CAJ", encodedTexture);
        PlayerPrefs.Save();
