...
public class JarCAJSprite : MonoBehaviour
{
    public static JarCAJSprite Instance;
    ...
    void Start()
    {
        Debug.Log("Jar script started.");

        if (targetSpriteRenderer != null)
        {
            Debug.Log("Jar SpriteRenderer is assigned.");
        ...
        {
            Debug.LogError("Jar SpriteRenderer is not assigned.");
        }
    }
    ...
    private void SaveTexture(Texture2D texture)
    {
        ...
        PlayerPrefs.SetString("SavedJarCAJ", encodedTexture);
        PlayerPrefs.Save();
