...
public class Stone3CAJSprite : MonoBehaviour
{
    public static Stone3CAJSprite Instance;
    ...
    void Start()
    {
        Debug.Log("Stone3 script started.");

        if (targetSpriteRenderer != null)
        {
            Debug.Log("Stone3 SpriteRenderer is assigned.");
        ...
        {
            Debug.LogError("Stone3 SpriteRenderer is not assigned.");
        }
    }
    ...
    private void SaveTexture(Texture2D texture)
    {
        ...
        PlayerPrefs.SetString("SavedStone3CAJ", encodedTexture);
        PlayerPrefs.Save();
