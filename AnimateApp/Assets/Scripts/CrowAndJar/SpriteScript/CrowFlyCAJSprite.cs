...
public class CrowFlyCAJSprite : MonoBehaviour
{
    public static CrowFlyCAJSprite Instance;
    ...
    void Start()
    {
        Debug.Log("CrowFly script started.");

        if (targetSpriteRenderer != null)
        {
            Debug.Log("CrowFly SpriteRenderer is assigned.");
        ...
        {
            Debug.LogError("CrowFly SpriteRenderer is not assigned.");
        }
    }
    ...
    private void SaveTexture(Texture2D texture)
    {
        ...
        PlayerPrefs.SetString("SavedCrowFlyCAJ", encodedTexture);
        PlayerPrefs.Save();
