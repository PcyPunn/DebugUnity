...
public class CrowWalkCAJImage : MonoBehaviour
{
    public static CrowWalkCAJImage Instance;
    ...
    void Start()
    {
        Debug.Log("CrowWalk Image script started.");

        if (targetImage != null)
        {
            Debug.Log("CrowWalk Image is assigned.");
        ...
        {
            Debug.LogError("CrowWalk Image is not assigned.");
        }
    }
    ...
    private void SaveTexture(Texture2D texture)
    {
        ...
        PlayerPrefs.SetString("SavedCrowWalkImage", encodedTexture);
        PlayerPrefs.Save();
