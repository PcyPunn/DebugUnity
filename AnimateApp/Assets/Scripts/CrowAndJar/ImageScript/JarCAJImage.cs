...
public class JarCAJImage : MonoBehaviour
{
    public static JarCAJImage Instance;
    ...
    void Start()
    {
        Debug.Log("Jar Image script started.");

        if (targetImage != null)
        {
            Debug.Log("Jar Image is assigned.");
        ...
        {
            Debug.LogError("Jar Image is not assigned.");
        }
    }
    ...
    private void SaveTexture(Texture2D texture)
    {
        ...
        PlayerPrefs.SetString("SavedJarImage", encodedTexture);
        PlayerPrefs.Save();
