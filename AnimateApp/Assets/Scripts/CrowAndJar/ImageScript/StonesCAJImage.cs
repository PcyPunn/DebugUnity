...
public class StonesCAJImage : MonoBehaviour
{
    public static StonesCAJImage Instance;
    ...
    void Start()
    {
        Debug.Log("Stones Image script started.");

        if (targetImage != null)
        {
            Debug.Log("Stones Image is assigned.");
        ...
        {
            Debug.LogError("Stones Image is not assigned.");
        }
    }
    ...
    private void SaveTexture(Texture2D texture)
    {
        ...
        PlayerPrefs.SetString("SavedStonesImage", encodedTexture);
        PlayerPrefs.Save();
